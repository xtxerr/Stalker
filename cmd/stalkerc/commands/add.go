...
// includes the target creation API (SNMPTargetConfig, CreateTargetRequest fields, etc.)
...
import (
	...
	"github.com/xtxerr/stalker/cmd/stalkerc/oids"
	"github.com/xtxerr/stalker/cmd/stalkerc/shell"
